<script>
	...
	onMount(()=>{
		...
		window.onscroll = ()=>{
			...
			// header.style.backgroundColor = `rgba(19, 20, 100, ${(transPoint-window.div.getBoundingClientRect().top)/transPoint}`
		}
	})
</script>

<header class="w-full flex text-white items-center sticky top-0">
